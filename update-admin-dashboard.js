...
// Now replace the entire "documents" tab content
const documentsRegex = /\{activeModalTab === 'documents' && \([\s\S]*?\}\)/;

const newDocumentsTab = `{activeModalTab === 'documents' && (
...
content = content.replace(documentsRegex, newDocumentsTab);

fs.writeFileSync('app/admin/dashboard/page.tsx', content, 'utf8');
console.log('app/admin/dashboard/page.tsx updated with full documents tab');
