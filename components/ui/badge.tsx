...
const badgeVariants = cva(
  'inline-flex items-center rounded-lg border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        info: 'border-blue-200 bg-blue-50 text-blue-800 font-semibold',
      },
    },
    defaultVariants: {
      variant: 'default',
