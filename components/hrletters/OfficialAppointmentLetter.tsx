...
export const OfficialAppointmentLetter: React.FC<OfficialAppointmentLetterProps> = ({
  ...
  return (
    <div
      className={`relative w-full max-w-4xl mx-auto text-gray-900 shadow-2xl rounded-xl p-8 md:p-12 border border-amber-300/60 overflow-hidden ${isPrintView ? "p-0 shadow-none border-none" : ""}`}
    ...
    >
      ...
      <div className="text-xs md:text-sm mb-5 relative z-10 space-y-0.5">
        <div className="flex items-end justify-between gap-4">
          <div className="flex items-end gap-2 flex-1 max-w-[320px]">
            ...
            <div className="flex-1 relative pb-[1px] min-w-0 overflow-hidden">
              ...
              <span className="relative font-bold text-gray-950 tracking-tight ml-2">{displayRef}</span>
            </div>
          </div>
          <div className="flex items-end gap-2 shrink-0 w-[200px]">
            ...
            <div className="flex-1 relative pb-[1px] min-w-0 overflow-hidden">
              ...
              <span className="relative font-bold text-gray-950 uppercase tracking-tight ml-2">{issueDate}</span>
            </div>
          </div>
        </div>
        <div className="flex items-end gap-2 max-w-[320px]">
          ...
          <div className="flex-1 relative pb-[1px] min-w-0 overflow-hidden">
            ...
            <span className="relative font-bold text-gray-950 tracking-tight ml-2">{yourRef || "\u00A0"}</span>
          </div>
        </div>
      </div>
      ...
      {/* SALUTATION */}
      <div className="mb-4 text-xs md:text-sm font-serif text-gray-900 relative z-10">{salutation}</div>
