          ...
          <div className="flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 dark:text-slate-400 px-1 pt-1 gap-2">
            <span>
              ...
              {selectedStaffIds.length > 0 && (
                <span className="ml-2 px-2 py-0.5 rounded bg-emerald-50 dark:bg-emerald-950 text-emerald-600 font-bold">
            ...
            <div className="flex items-center gap-2">
              {selectedStaffIds.length > 0 && (
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white font-bold text-xs flex items-center gap-1.5 shadow-xs transition disabled:opacity-50"
                >
                    ...
                    return (
                      <tr
                        ...
                        className={`hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition ${
                          selectedStaffIds.includes(staff.id) ? "bg-emerald-50/40 dark:bg-emerald-950/20" : ""
                        }`}
                      >
                        {/* Checkbox Selection */}
                        ...
                        <td className="px-4 py-3.5">
                          <div>
                            <Link
                              href={`/staff/${staff.id}`}
                              className="font-bold text-slate-900 dark:text-white hover:text-emerald-600 dark:hover:text-emerald-400 transition"
                            >
                              {staff.full_name}
                            </Link>
                          ...
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            {currentContract && !currentContract.is_terminated && (
                              <button
                                ...
                                className="p-1.5 rounded-lg text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-950/60 dark:text-emerald-400 transition"
                              >
